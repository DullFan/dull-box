...
public class UserController extends ABaseController {
    ...
    public Result resetPassword(@RequestBody @Validated ResetPassword resetPassword) {
    ...
    @GetMapping("/searchHistories")
    public Result searchHistories(){
        List<BoxUserSearchHistory> boxUserSearchHistories =  boxUserSearchHistoryService.selectByUserId(getUserId());
        return success(boxUserSearchHistories);
    }
    ...
    public Result deleteUserByUserIdBatch(@RequestParam List<Long> list) {
        isAdmin();
